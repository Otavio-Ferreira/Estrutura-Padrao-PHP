        ...
        <nav id="sidebar" class="sidebar">
            <div class="sidebar-content js-simplebar">
                <a class="sidebar-brand" href="#">
                    <span class="align-middle">Othek Books</span>
                </a>
                <ul class="sidebar-nav">
                    ...
                    <li class="sidebar-item <?= (isset($viewData['nivel-1']) && $viewData['nivel-1'] == "Products")?'active':''; ?>">
                        <a class="sidebar-link" href="<?= BASE_URL.'Products';?>">
                            <i class="align-middle" data-feather="box"></i> <span class="align-middle">Produtos</span>
                        </a>
                    </li>
                    <!--  -->
